  ...
  return (
    ...
    >
              ...
              >
                <Tilt tiltMaxAngleX={8} tiltMaxAngleY={8} scale={1.0}>
                  ...
                  >
                    ...
                    <p className="mt-1 text-[10px] sm:text-xs text-emerald-700 text-center line-clamp-5 relative z-10">
                      {flower.use}
                    </p>
      ...
      <div className="fixed bottom-4 right-4 md:top-1/2 md:-translate-y-1/2 md:right-6 w-[90%] max-w-xs md:w-72 z-50">
        <div className="bg-white/80  border border-emerald-200 rounded-2xl shadow-xl p-4">
